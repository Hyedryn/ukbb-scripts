...
def gen_folder_structure(scratch_path):
    os.makedirs(os.path.join(scratch_path,".slurm"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,".slurm_multisubjects"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"COMPLETED"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"dataset_template"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"dataset_template","derivatives"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"FAILED"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"fmriprep"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"nearline"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"scripts"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"scripts","data"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"slurm_logs"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"slurm_logs_multisubjects"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"tmp_archive"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"ukbb_bids"), exist_ok = True)
    os.makedirs(os.path.join(scratch_path,"workdir"), exist_ok = True)
